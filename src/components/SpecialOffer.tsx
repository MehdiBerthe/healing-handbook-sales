            ...
            <div className="space-y-6">
              <div className="flex justify-center mb-6">
                <div className="w-64 h-64 rounded-lg shadow-natural overflow-hidden">
                  <img src="/lovable-uploads/1a459dfa-0daf-408b-b2dd-153d72026e36.png" alt="The Natural Medicine Book - Traditional Remedies for Modern Times" className="w-full h-full object-cover rounded-lg shadow-natural" />
                </div>
              </div>
