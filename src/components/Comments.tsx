  ...
  return <section className="py-12 md:py-20 bg-blue-50">
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="space-y-0">
          {comments.map((comment, index) => <div key={comment.id} className={`bg-card p-4 ${index === 0 ? 'rounded-t-lg' : ''} ${index === comments.length - 1 ? 'rounded-b-lg' : ''} ${index !== comments.length - 1 ? 'border-b border-border/50' : ''}`}>
              <div className="flex space-x-3">
                <Avatar className="w-10 h-10 flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {comment.likes > 0 && <div className="flex items-center space-x-1 mt-1 ml-3">
