  ...
  return (
    <section className="py-16 px-4 bg-background">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="bg-gradient-natural rounded-2xl p-8 mb-12 text-white text-center">
          <h3 className="text-2xl font-bold mb-4">Real Example: The Turmeric Transformation</h3>
          ...
          <div className="bg-white/20 rounded-lg p-6 inline-block">
            <div className="flex items-center justify-center gap-4 text-2xl font-bold">
              ...
              <span>=</span>
              <span className="text-natural-gold">2000% Increase</span>
            </div>
            <p className="text-sm mt-2 opacity-90">in bioavailability and absorption</p>
          </div>
        </div>
