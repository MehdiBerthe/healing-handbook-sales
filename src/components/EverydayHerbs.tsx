...
export function EverydayHerbs() {
  ...
  return <section className="py-12 md:py-16 px-4 bg-gradient-subtle">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="flex justify-center lg:order-last">
            <img alt="Everyday herbs and ingredients with arrows showing chemical compounds" className="rounded-2xl shadow-warm max-w-full h-auto" src="/lovable-uploads/6d7bc937-00a4-462f-a46c-64d45c0eae88.png" />
          </div>

          <div className="space-y-3 md:space-y-4">
            {herbSecrets.map((secret, index) => <Card key={index} className="border-natural-gold-light hover:border-natural-gold hover:shadow-warm transition-all duration-300 group cursor-pointer">
