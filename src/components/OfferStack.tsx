          ...
          <Card className="bg-white border-2 border-forest-green shadow-lg overflow-hidden">
            ...
            <CardContent className="p-6 md:p-8">
              ...
              <div className="text-center mb-6">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">The Natural Healing Handbook</h3>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-900 font-medium">1 Copy of The Natural Healing Handbook</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Check className="w-6 h-6 text-forest-green mt-1 flex-shrink-0" />
                    <div>
