      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex justify-center mb-6 md:mb-8">
          <div className="relative max-w-sm md:max-w-md w-full">
            ...
            {/* Zoom-in callouts - Hidden on mobile for cleaner look */}
            <div className="hidden xl:block absolute -right-8 top-1/4 bg-white p-3 rounded-lg shadow-lg border-2 border-forest-green/20 max-w-[200px] z-20">
            ...
            <div className="hidden xl:block absolute -right-12 bottom-1/4 bg-white p-3 rounded-lg shadow-lg border-2 border-forest-green/20 max-w-[200px] z-20">
        ...
        {/* Trust badge - shown below image on mobile, above text content on desktop */}
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-3 mb-6 md:mb-8 text-left max-w-2xl mx-auto">
          ...
          <div className="bg-forest-green/10 p-3 md:p-4 rounded-lg mb-4 md:mb-6 border border-forest-green/20 max-w-2xl mx-auto">
