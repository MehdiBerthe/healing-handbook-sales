  ...
  return <section className="relative bg-gradient-to-br from-healing-green/5 to-natural-gold/5 pt-8 pb-16 lg:pt-12 lg:pb-24 mt-4">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          {/* Subheadline */}
          <p className="text-xl lg:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">"Forget overpriced pills and confusing advice. This $34.99 Natural Medicine Book is helping thousands over 50 feel sharper, lighter and regain control, naturally."</p>
          
          {/* Author Info */}
          <div className="space-y-2">
            <p className="text-lg font-semibold text-earth-brown">By Emma Lang | Health Contributor</p>
